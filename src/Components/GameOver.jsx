...
export default function GameOver({ handleSound }) {
	return (
		<div
			className={`w-[450px] h-[300px] bg-slate-950 text-white flex flex-col justify-center items-center gap-3 rounded-md p-5 text-md font-press-start shadow-red-700 shadow-[10px_15px_25px] border-white border-8 border-double`}
		>

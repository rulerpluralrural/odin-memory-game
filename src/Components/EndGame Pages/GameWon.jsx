...
const buttonStyle =
	"hover:animate-pulse focus:animate-pulse hover:border-b-2 focus:border-b-2 border-slate-950 border-dashed outline-none";
...
export default function GameWon({
	...
	return (
		...
		>
			<p className="text-center text-3xl border-2 p-5 border-slate-800 rounded-md">
				You Win!
			</p>
			<p>Play Again?</p>

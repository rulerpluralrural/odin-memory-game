	...
	return (
		<div className="w-full flex flex-col sm:flex-row sm:justify-between items-center">
			<img
				...
				onClick={restartGame}
			/>
			<div className="flex flex-col items-start text-left mr-5 text-white font-press-start w-[260px] backdrop-blur-lg border-4 border-double p-3 border-green-300 rounded-sm">
				<h1>
